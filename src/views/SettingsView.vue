          ...
          <div class="col-span-full flex items-center gap-x-8">
            ...
            <div>
              <button v-on:click="openModal = true" type="button"
                class="rounded-md bg-black/10 px-3 py-2 text-sm font-semibold text-black shadow-sm hover:bg-black/20">
                Cambiar Foto
              </button>
    ...
    <div class="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8">
      <div>
        ...
        <p class="mt-1 text-sm leading-6 text-gray-400">
          Puedes borrar tu cuenta de usuario justo aqui. Esta accion no es reversible. Toda la Informacion relevante sera borrada permanentemente
        </p>
      </div>
