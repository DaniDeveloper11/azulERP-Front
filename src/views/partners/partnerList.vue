    ...
    <div >
      <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
          ...
          <p class="mt-2 text-sm text-gray-700">Socios de negocios son todas aquellas entidades(Empresas o individuos), que estan asociados a la destiladora de alguna forma, ya sea como proveedor o como cliente</p>
        </div>
